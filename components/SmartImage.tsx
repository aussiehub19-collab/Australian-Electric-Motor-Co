  ...
  return (
    ...
    >
      <Image
        ...
        alt={alt || 'Dirt & Co electric dirt bike'}
        width={width}
        height={height}
        priority={priority}
