...
export const RIDING_GEAR_PRODUCTS = [
  ...
  {
    slug: 'fist-handwear-chapter-gloves-au-flag',
    name: 'Fist Handwear Chapter Off-Road Gloves (AU Flag Edition)',
    price: 45,
    category: 'gloves-goggles',
    parentCategory: 'riding-gear',
    parentCategories: ['riding-gear', 'gloves-goggles'],
    brand: 'fist-handwear',
    brandName: 'Fist Handwear',
    badge: 'Aussie Flag Icon',
    featured: true,
    isGear: true,
    safetyStandard: 'CE Level 1',
    ...
    specs: {
      Design: 'Australian Flag Edition Sublimated Artwork',
      Palm: 'Minimalist Pre-Curved Clarino Palm for Maximum Feel',
      Closure: 'Custom Hook-and-Loop Fist Rubber Pull Tab',
      Touchscreen: 'Conductive Thread on Index Finger & Thumb for Smartphone Use',
      Origin: 'Designed by Australian Motocross Riders on the Gold Coast',
      Warranty: '1-Year Australian Warranty',
    },
  },
